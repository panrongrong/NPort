...
#ifndef __INCpciHeaderDefs3h
#define __INCpciHeaderDefs3h
...
typedef struct pciHeaderDevice3
    {
...
typedef struct pciHeaderBridge3
    {
    short   vendorId;   /* vendor ID */
    short   deviceId;   /* device ID */
    short   command;    /* command register */
...
typedef struct pciHeaderCardBusBridge3
    {
    short   vendorId;   /* vendor ID */
    short   deviceId;   /* device ID */
    short   command;    /* command register */
