...
UINT32 sdLibDbgMask = SD_LIB_DBG_OFF;
...
STATUS mmcSwitch
    ...
    do
        ...
        timeOut++;
        if (timeOut >= SDMMC_COMMAND_TIMEOUT*2)
            return (ERROR);
...
STATUS sdCmdReadBlock
	...
	/*printf(">>>sdCmdReadBlock->numBlks:%d,cmd_idx:%d \n ", numBlks, idx);*/
...
STATUS sdCmdWriteSingleBlock
	...
	/*printf(">..>sdCmdWriteSingleBlock->numBlks:%d,cmd_idx:%d \n ", 1, SDMMC_CMD_WRITE_SINGLE_BLOCK);*/
...
STATUS sdCmdWriteMultipleBlock
	...
	/*printf(">...>sdCmdWriteMultipleBlock->numBlks:%d,cmd_idx:%d \n ", numBlks, SDMMC_CMD_WRITE_MULTI_BLOCK);*/
...
STATUS sdCmdWriteBlock
	...
	/*printf(">->sdCmdWriteBlock->numBlks:%d,cmd_idx:%d \n ", numBlks, idx);*/
