...
#ifdef INCLUDE_GMAC_FM_END
IMPORT void vxbGmacFmEndRegister (void);
#endif /* INCLUDE_GMAC_FM_END */
...
#ifdef DRV_ALT_SOC_GEN5_FPGA_MGR
IMPORT void vxbAltSocGen5FpgaMgrRegister (void);
#endif /* DRV_ALT_SOC_GEN5_FPGA_MGR */

#ifdef DRV_ALT_SOC_GEN5_PCIEX
IMPORT void vxbAltSocGen5PciExRegister (void);
#endif /* DRV_ALT_SOC_GEN5_PCIEX */
...
IMPORT 	armv7GenTimerDrvRegister (void);
#endif /* INCLUDE_ALT_SOC_GEN5_TIMER */
...
extern void armGlobalTimerDrvRegister (void);
...
#ifdef DRV_INTCTLR_CORTEXM
extern void vxbCortexMIntCtlrRegister(void);
#endif /* DRV_INTCTLR_CORTEXM */

#ifdef DRV_CORTEXM_SYSTICK
IMPORT void vxbCortexMSysTickDrvRegister (void);
#endif /* DRV_CORTEXM_SYSTICK */
...
#ifdef DRV_VXB_FCM
extern STATUS vxbFcmRegister (void);
#endif /* DRV_VXB_FCM */
...
extern void vxbFslSataStorageRegister (void);
    ...
    extern void fslSdhcRegister (void);
...
#ifdef DRV_VXB_GPMC
extern STATUS vxbGpmcRegister (void);
#endif /* DRV_VXB_GMPC */
...
#ifdef DRV_VXB_IFCM
extern STATUS vxbIfcmRegister (void);
#endif /* DRV_VXB_IFCM */
...
#ifdef DRV_I2C_K70
IMPORT void k70I2cRegister ();
#endif /* DRV_I2C_K70 */
#ifdef DRV_SIO_K70
IMPORT void vxbK70SioDrvRegister (void);
#endif /* DRV_SIO_K70 */

#ifdef DRV_K70_TIMER
IMPORT void vxbK70TimerDrvRegister(void);
#endif /* DRV_K70_TIMER */

#ifdef DRV_GPIO_KINETIS
IMPORT void vxbKinetisGpioDrvRegister (void);
#endif /* DRV_GPIO_KINETIS */
...
#ifdef DRV_MMCSTORAGE_CARD
    extern void vxbMmcStorageRegister (void);
#endif /* DRV_MMCSTORAGE_CARD */
...
IMPORT void octeonSdhcRegister(void);
...
#ifdef DRV_PCI_SDHC_CTRL
    extern void pciSdhcRegister (void);
#endif /* DRV_PCI_SDHC_CTRL */
...
#ifdef DRV_SDSTORAGE_CARD
    extern void vxbSdStorageRegister (void);
#endif /* DRV_SDSTORAGE_CARD */
...
#ifdef DRV_VXBEND_STM32F
extern void vxbStm32fEndRegister (void);
#endif /* DRV_VXBEND_STM32F */

#ifdef DRV_SIO_STM32F
extern void vxbStm32fSioDrvRegister (void);
#endif /* DRV_SIO_STM32F */


#ifdef DRV_STM32F_TIMER
extern void vxbStm32fTimerDrvRegister (void);
#endif /* DRV_STM32F_TIMER */
...
#ifdef DRV_TI_KEYSTONE_SPI
IMPORT void tiKeystoneSpiRegister(void);
#endif /* DRV_TI_KEYSTONE_SPI */

#ifdef DRV_TI_MMCHS_CTRL
    extern void tiMmchsRegister (void);
#endif /* DRV_TI_MMCHS_CTRL */


#ifdef INCLUDE_TI_NETCP_END
    IMPORT void vxbTiNetcpRegister (void);
#endif /* INCLUDE_TI_NETCP_END */	
...
/* add by jc */
#ifdef DRV_FM_QSPI
/*extern void vxQspiRegister (void);*/
#endif
...
/*
 * Copyright (c) 2008-2014,2017-2018 Wind River Systems, Inc.
 *
 * The right to copy, distribute, modify or otherwise make use
 * of this software may be licensed only pursuant to the terms
 * of an applicable Wind River license agreement.
...
--------------------
02c,09mar17,syt  fix errors in linkSpeed() and vxbPcieExtCapAerShow().(VXW6-86450)
02b,07feb17,syt  corrected an array defination error in vxbPcieExtCapAerShow(VXW6-85938).
02a,20mar14,d_l  fix hwMemAlloc memory leak. (VXW6-80736)
01z,16dec13,xms  check vxbDevMethodGet return value. (WIND00445654)
01y,04sep13,xms  fix NULL_RETURNS error. (WIND00414265)
...
/*********************************************************************
*
* linkSpeed - returns string for speed
*
    ...
    while (capId)
        ...
        switch(capId)
            ...
            case  PCIE_EXT_CAP_ID_ERR:
                printf ("Advanced Error Reporting. 0x%x. Version %d. \r\n", pos, version);
...
#ifdef INCLUDE_SD_BUS
    IMPORT void sdRegister (void);
#endif /* INCLUDE_SD_BUS */
...
IMPORT STATUS spiRegister (void);
...
#ifdef DRV_ALT_SOC_GEN5_FPGA_MGR
    vxbAltSocGen5FpgaMgrRegister ();
#endif /* DRV_ALT_SOC_GEN5_FPGA_MGR */

#ifdef DRV_ALT_SOC_GEN5_PCIEX
    vxbAltSocGen5PciExRegister ();
#endif /* DRV_ALT_SOC_GEN5_PCIEX */
...
#ifdef DRV_INTCTLR_CORTEXM
    vxbCortexMIntCtlrRegister();
#endif /* DRV_INTCTLR_CORTEXM */

#ifdef DRV_CORTEXM_SYSTICK
    vxbCortexMSysTickDrvRegister ();
#endif /* DRV_CORTEXM_SYSTICK */
...
#endif /* DRV_I2C_K70 */
#ifdef DRV_SIO_K70
    vxbK70SioDrvRegister ();
#endif /* DRV_SIO_K70 */
#ifdef DRV_K70_TIMER
    vxbK70TimerDrvRegister();
#endif /* DRV_K70_TIMER */
#ifdef DRV_GPIO_KINETIS
    vxbKinetisGpioDrvRegister ();
#endif /* DRV_GPIO_KINETIS  */
...
#ifdef DRV_OCTEON_SDHC_CTRL
    void octeonSdhcRegister(void);
#endif
...
#ifdef DRV_VXBEND_STM32F
    vxbStm32fEndRegister ();
#endif /* DRV_VXBEND_STM32F */

#ifdef DRV_SIO_STM32F
    vxbStm32fSioDrvRegister ();
#endif /* DRV_SIO_STM32F */


#ifdef DRV_STM32F_TIMER
    vxbStm32fTimerDrvRegister ();
#endif /* DRV_STM32F_TIMER */
