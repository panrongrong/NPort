...
void VMODE_640x480_init(void) 
{
	VideoMode * pMode =  (VideoMode *)&VMODE_640x480;
	
	/*pMode->label = "640x480@60Hz";*/
	sprintf(pMode->label, "%s", "640x480@60Hz");
...
void  VMODE_800x600_init(void)
{
	VideoMode * pMode =  (VideoMode *)&VMODE_800x600;
	
	/* pMode->label = "800x600@60Hz";*/
	sprintf(pMode->label, "%s", "800x600@60Hz");
...
void  VMODE_1280x1024_init(void)
{
	VideoMode * pMode =  (VideoMode *)&VMODE_1280x1024;
	
	/* pMode->label = "1280x1024@60Hz";*/
	sprintf(pMode->label, "%s", "1280x1024@60Hz");
...
void  VMODE_1280x720_init(void)
{
	VideoMode * pMode =  (VideoMode *)&VMODE_1280x720;
	
	/* pMode->label = "1280x720@60Hz";*/
	sprintf(pMode->label, "%s", "1280x720@60Hz");
	...
	pMode->vmax = 749;
	pMode->vpol = 1;
	pMode->freq = 74.25; /* 74.2424 is close enough*/

	return;
}

void  VMODE_1920x1080_init(void)
{
	VideoMode * pMode =  (VideoMode *)&VMODE_1920x1080;
	
	/* pMode->label = "1920x1080@60Hz";*/
	sprintf(pMode->label, "%s", "1920x1080@60Hz");
	...
	pMode->vmax = 1124;
	pMode->vpol = 1;
	pMode->freq = 148.5; /* 148.57 is close enough*/
...
void vmode_init_all(void)
{
	VMODE_640x480_init();
	VMODE_800x600_init();
	VMODE_1280x1024_init();
	VMODE_1280x720_init();
	VMODE_1920x1080_init();
