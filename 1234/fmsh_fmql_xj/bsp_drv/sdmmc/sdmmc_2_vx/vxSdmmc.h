...
#ifndef __INC_VX_SDMMC_H__
#define __INC_VX_SDMMC_H__

#include "./../../dma/dma_2_vx/vxDma.h"
...
#define SDMMC_WRITE_MODE     (0)
#define SDMMC_READ_MODE      (1)
...
typedef struct _t_sdmmc_all_
{
	int sdmmc_x;

	vxT_SDMMC_CTRL * pSdmmcCtrl;
	
	vxT_SDMMC_CARD * pSdmmcCard;
	
	vxT_SDMMC_CMD * pSdmmcCmd;

	vxT_DMA_CTRL * pSdmmcDMA;

	int init_flag;  /* 0-not init, 1-init_already*/
...
/*  sdmmc with dma_mode*/
/**/
extern vxT_DMA * g_pDma;
extern void dmaCtrl_Enable_Ctrl(vxT_DMA* pDma);

extern int vxInit_Dma_1(void);
extern int vxInit_Dma_2(void);

#ifdef __cplusplus
}
#endif /* __cplusplus */

#endif /* __INC_VX_SDMMC_H__ */
