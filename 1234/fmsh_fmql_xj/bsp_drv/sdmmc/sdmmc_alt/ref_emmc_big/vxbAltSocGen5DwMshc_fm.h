...
#define ALT_MSHC_PLDMND_84H                 (0x084)  /* */
#define ALT_MSHC_DBADDR_88H                 (0x088)  /* */
#define ALT_MSHC_IDSTS_8CH                  (0x08c)  /* */
#define ALT_MSHC_IDINTEN_90H                (0x090)  /* */
...
*/
#define ALT_MSHC_DATA_FIFO                   (0x200)
#else
/* 
DATA	>= 0x100	R/W	数据FIFO读/写 Reset Value: 32’hx 
*/
#define ALT_MSHC_DATA_FIFO                   (0x100)
#endif
...
#define ALT_MSHC_INT_CMD_DONE           (1 << 2)
...
#define ALT_MSHC_INT_PIO_DEFAULTS       (ALT_MSHC_INT_RXDR | ALT_MSHC_INT_CD | \
                                         ALT_MSHC_INT_DTO | ALT_MSHC_INT_CMD_DONE | \
                                         ALT_MSHC_INT_ERROR | ALT_MSHC_INT_TXDR)
                                         
#define ALT_MSHC_INT_DMA_DEFAULTS       (ALT_MSHC_INT_CMD_DONE | ALT_MSHC_INT_DTO | \
...
#define ALT_MSHC_DEFAULT_FIFO_LEN       (16)  /* 1024 -> 16 */
...
#else
#define ALT_MSHC_DEFAULT_TIMEOUT        (0xFFFFFFFF)
#endif

#define ALT_MSHC_MAX_RETRIES            (50000)  /* 50000 -> 100000 */
...
#define ALT_MSHC_MAX_RW_SECTORS         (1)
...
#define ALT_DW_MSHC_CMD_WAIT_IN_SECS    (20)  /* 10 */

/* card monitor task check status change delay */
#define ALT_DW_MSHC_CARDMON_DELAY_SECS  (4)  /* 2 */
