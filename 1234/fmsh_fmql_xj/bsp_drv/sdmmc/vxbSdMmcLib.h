...
#else  /* jc*/
#define SDMMC_CMD_RSP_LEN48     (1 << 0)
#define SDMMC_CMD_RSP_LEN136    (1 << 1)
#define SDMMC_CMD_RSP_CMDIDX    (1 << 4)
#define SDMMC_CMD_RSP_CRC       (1 << 2)
#define SDMMC_CMD_RSP_BUSY      (1 << 3)
...
#define OCD_VDD_165_195		0x00000080	/* VDD voltage 1.65 - 1.95 */
