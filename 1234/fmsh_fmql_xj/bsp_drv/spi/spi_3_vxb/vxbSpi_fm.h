...
#ifndef __INCvxbFmshSpih
#define __INCvxbFmshSpih
...
typedef struct fm_spi_drv_ctrl
{
    VXB_DEVICE_ID    pDev;
    void *           regBase;
    void *           regHandle;
	...
	int              isSlave;  /* flase(0)-master, true(1)-slave */
