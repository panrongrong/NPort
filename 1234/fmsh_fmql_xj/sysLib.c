...
void sysHwInit0 (void)
{
	...
	tmp32 = (tmp32 & (~0xE00));            /* IO_Type: disalbe uart_1_rx (000: 閸忚櫕鏌嘔O")*/
...
min-system or whole-functions
	...
	GMAC_PHY_INTF_SEL2	6:4	rw	0x0	"PHY Interface Select
			...
			閳伙拷101: RTBI 
			閳伙拷110: SMII 
			閳伙拷111: RevMII  	Active State: N/A"
...
void reboot2(void)
{
	/*
	PSS_RST_CTRL	0x200	
			reserved	31:1	rw	0x0	Reserved. 閸愭瑦妫ら弫鍫礉鐠囪璐�
			SOFT_RST	0	w	0x0	"PS缁崵绮烘潪顖氼樉娴ｅ秲锟�
							0閿涙矮绗夋径宥勭秴
							1閿涙瓍S鏉烆垰顦炬担宥忕礄闂勩倖妞傞柦鐔堕獓閻㈢喐膩閸ф顧囬敍锟�							濞夈劍鍓伴敍姘劃婢跺秳缍呮稉宥夋付鐟曚礁鍟�濞撳懘娅庨妴鍌溾�娴犺埖妲搁懛顏呯闂嗗墎娈戦妴锟�
	 */
	/*婢跺秳缍匭spi0 flash閿涘苯鍨忛崶鐐插煂3鐎涙濡Ο鈥崇础閿涘奔绗夎ぐ鍗炴惙bootrom閸旂姾娴噁sbl閸氼垰濮�*/
