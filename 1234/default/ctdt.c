...
#endif
#endif
__asm("	.ascii \"set WIND_HOME D:/WindRiver69_new/WindRiver69_new\"");
__asm("	.byte 0");
__asm("	.ascii \"set PRJ_FULL_PATH D:/vxworkspace/FMSH/1234\"");
__asm("	.byte 0");
...
static const char oscbOSBuildPath[] = "D:/vxworkspace/FMSH/1234";
